/*
** cylindre.c for rt in /home/descam_d/rendu/IGRAPH/MUL_2014_rtracer/scene_editor
** 
** Made by Corentin Descamps
** Login   <descam_d@epitech.net>
** 
** Started on  Fri Jun  5 16:41:21 2015 Corentin Descamps
** Last update Sun Jun  7 17:52:14 2015 Corentin Descamps
*/
...
void		form_cyl(GtkWidget *Window)
{
  t_wid		*Widget;
  GtkWidget	*Save;
  GtkWidget	*Grid;
  ...
  g_signal_connect(G_OBJECT(Save), "clicked", G_CALLBACK(save_cyl), Widget);
}

void		add_cyl(GtkWidget *Widget, gpointer data)
{
  GtkWidget	*Window;
  ...
  gtk_window_set_title(GTK_WINDOW(Window), "New Cylindre");
