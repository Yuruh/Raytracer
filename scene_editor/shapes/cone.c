/*
** cone.c for rt in /home/descam_d/rendu/IGRAPH/MUL_2014_rtracer/scene_editor/shapes
** 
** Made by Corentin Descamps
** Login   <descam_d@epitech.net>
** 
** Started on  Fri Jun  5 17:22:23 2015 Corentin Descamps
** Last update Sun Jun  7 16:59:38 2015 Corentin Descamps
*/
...
void		form_cone(GtkWidget *Window)
{
  t_wid		*Widget;
  GtkWidget	*Save;
  GtkWidget	*Grid;
  ...
  g_signal_connect(G_OBJECT(Save), "clicked", G_CALLBACK(save_cone), Widget);
}

void		add_cone(GtkWidget *Widget, gpointer data)
{
  GtkWidget	*Window;
  ...
  gtk_window_set_title(GTK_WINDOW(Window), "New Cone");
